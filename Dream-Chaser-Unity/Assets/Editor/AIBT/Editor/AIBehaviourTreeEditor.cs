...
public class AIBehaviourTreeEditor : EditorWindow
{
    ...
    public void CreateGUI()
    {
        ...
        // Import UXML
        var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Editor/AIBT/Editor/AIBehaviourTreeEditor.uxml");
        visualTree.CloneTree(root);
       

        // A stylesheet can be added to a VisualElement.
        // The style will be applied to the VisualElement and all of its children.
        var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Editor/AIBT/Editor/AIBehaviourTreeEditor.uss");
